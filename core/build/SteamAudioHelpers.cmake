...
function (get_local_lib_path LIB_PATH)
	...
	elseif (IPL_OS_UWP)
		if (IPL_CPU_X86)
			set(${LIB_PATH} ${CMAKE_HOME_DIRECTORY}/lib/uwp-x86 PARENT_SCOPE)
		elseif (IPL_CPU_X64)
			set(${LIB_PATH} ${CMAKE_HOME_DIRECTORY}/lib/uwp-x64 PARENT_SCOPE)
		elseif (IPL_CPU_ARMV8)
			set(${LIB_PATH} ${CMAKE_HOME_DIRECTORY}/lib/uwp-arm64 PARENT_SCOPE)
		endif()
	elseif (IPL_OS_SCARLET)
		if (IPL_CPU_X86)
			set(${LIB_PATH} ${CMAKE_HOME_DIRECTORY}/lib/scarlet-x86 PARENT_SCOPE)
		elseif (IPL_CPU_X64)
			set(${LIB_PATH} ${CMAKE_HOME_DIRECTORY}/lib/scarlet-x64 PARENT_SCOPE)
		elseif (IPL_CPU_ARMV8)
			set(${LIB_PATH} ${CMAKE_HOME_DIRECTORY}/lib/scarlet-arm64 PARENT_SCOPE)
		endif()
	endif()
endfunction()
...
function (get_bin_subdir BIN_SUBDIR)
	...
	elseif (IPL_OS_UWP)
		if (IPL_CPU_X86)
			set(${BIN_SUBDIR} uwp-x86 PARENT_SCOPE)
		elseif (IPL_CPU_X64)
			set(${BIN_SUBDIR} uwp-x64 PARENT_SCOPE)
		elseif (IPL_CPU_ARMV8)
			set(${BIN_SUBDIR} uwp-arm64 PARENT_SCOPE)
		endif()
	elseif (IPL_OS_SCARLET)
		if (IPL_CPU_X86)
			set(${BIN_SUBDIR} scarlet-x86 PARENT_SCOPE)
		elseif (IPL_CPU_X64)
			set(${BIN_SUBDIR} scarlet-x64 PARENT_SCOPE)
		elseif (IPL_CPU_ARMV8)
			set(${BIN_SUBDIR} scarlet-arm64 PARENT_SCOPE)
		endif()
	endif()
endfunction()
